...
public class Constants {
	...
	public enum Channels {
		GAMER("702846310436438036"), NSFW("699751218179997816"), ROLE(
				"753590868270776331"), BOT_SNAPSHOT("724568288356597780"), GENERAL(
						"676731153444765709"), EPITA(
								"689491329402667064"), MEME("709396567894786060");
	...
	public enum Roles {
		ADMIN("677262572860342333"), MOD("678538602338189314"), MEMBER(
				"753758106579632188"), ARTISTIC("753757926317096960"), INTERNATIONAL(
						"771686251647467551"), GAMER("753757719017685073"), BROADCAST_MESSENGER(
								"1106324476242690111"), DEVELOPER("830156830374232064"), NSFW(
										"699751539832651836"), GLOBAL(
												"779398365523607573"), ING1("899330612454899732");
