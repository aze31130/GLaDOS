...
public class Statistics extends Command {
	...
	public void execute(Argument args) {
		...
		/*
		 * for(TextChannel ch :
		 * args.member.getJDA().getGuilds().get(1).getTextChannels()) {
	 ...
	 * channel.sendMessage("Calculating stats of channel: " +
	 ...
	 * resultString += Integer.toString(pair.messageAmount) + " ("+
	 * ((float)(pair.messageAmount * 100) / TotalMessage) +"%) " +
	 * pair.author.getName() + "\n";
	 * i++;
	 * }
