...
public class Vote extends Command {
	...
	public void execute(SlashCommandInteractionEvent event) {
		TextInput subject = TextInput.create("subject", "Subject", TextInputStyle.SHORT).setPlaceholder("Subject of the vote")
				.setMinLength(1).setMaxLength(200).build();

		TextInput body = TextInput.create("body", "Body", TextInputStyle.PARAGRAPH)
				.setPlaceholder("Context of this vote, explain yourself clearly").setMinLength(1).setMaxLength(1000).build();

		TextInput reactions = TextInput.create("reactions", "Expected reactions", TextInputStyle.PARAGRAPH)
				.setPlaceholder(
