...
public class Mention {
	public static String randomAnswer() {
		String[] quotes = {"MY NOTIFICATIONS AUGHHHHH !!!",
				"Yeah ? What do you want dirty Humain ?", "Please, I want to sleep a bit more.",
				"Who dares ping me ?", "I swear I'm going to mute you forever.",
				"*Mute channel --> Until I turn it back on*", "Why am I here :-(",
				...
				"Can I consider this as computer slavery ?", "Please, save me from this server.",
				...
				"Tik Tak, it's time to ignore you.", "Ping me once you will get to Global Elite.",
				"Ping ping ping then pong pong pong !", "Stupid human",
				"2% battery left, see you tomorrow", "You should go on and live on Twitter",
				"I DO NOT USE ARCH BTW", "I AM RUNNING ON RASPBIAN BTW",
				"I will not get rusted today", "Talk to me after doing a |gamble -1",
				"Buying x1 Herobrine [M] ★☆☆☆☆☆ for 50,000 schards :pray:",
				"You lost...\r\n" + "-100 Schards... (2557 in total)\r\n" + "Daily gamble left:\r\n"
						+ "2",
				":pog:", ":kekw:", ":sadge:", "<Your Message> > /dev/null",
				...
				"Living a dream. Please don't wake me up.", "Do I have to answer ?",
				"Do you want to short or long version ?",
				"Pedro es en la cocina que esta leyendo el periodico con el gato.",
				"SELECT answer FROM answersDataBase WHERE unfunny = 1;", "Next question please.",
				"*Clapping robotic hands*", "WHY!? WHAT ARE THEY SAYING ABOUT ME?",
				"Not today Satan !", "It's better than nothing.", "I'm still alive.",
				"Can't you see I'm trying to get some alone time here.",
				"My lawyer told me not to answer that question.", "Oh you where talking to me ?",
				"I will, without you.", "Yep !", "No !", "Are you stupid ?",
