...
public class Resolver {
	...
	public Resolver() {
		...
		this.Hash = Arrays.asList(new Couple("MD2", "713237ad968f5f8dca141e85d5463529"),
				new Couple("MD5", "bab81d93982f0faa2ea044ba7a01db80"),
				new Couple("SHA-1", "cd046bb214379e8feba77e5d48cd261a893fb1b4"),
				new Couple("SHA-256",
						"badca77dfe5feaaa7184e151878ca32b3d1d60eacd0669d1a666a720eba3d39e"),
				new Couple("SHA-384",
						"683ea641d65b79a2cef2aec236bd1b7c3b8dd21e7194e3d80f67a738246d40a378138e4114e324d1ada4bfc81b85ad27"),
				new Couple("SHA-512",
						"722522408ee185dd7f15b33f57a793a5557c351621b364d56bbfc781557cb7922ed6d3c2c80a16139027f8c7a3d6e64e15709c891cc78e95f7f4ef648d94a837"));
	}

	public EmbedBuilder runTest(List<Attachment> list)
		...
		if (!list.isEmpty()) {
			for (Attachment attachment : list) {
				...
				for (Couple informations : Hash) {
					if (getFileChecksum(MessageDigest.getInstance(informations.hashName), file)
							.equals(informations.hashOutput)) {
